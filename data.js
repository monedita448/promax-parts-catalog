...
const CATALOG = [
  ...
  },
  {
    ...
    products: [
      ...
      { supplier: "injured-gadgets", id: "16-frontcam", category: "Camera", name: { en: "Front camera module", es: "Módulo de cámara frontal" }, gradeKey: "genuine", inStock: false, price: 86.03, colors: [], img: "images/16pm-frontcam.jpg", note: { en: "Requires Face ID transfer from the original module to calibrate. Rear camera module: limited genuine stock — confirm availability before quoting.", es: "Requiere transferir el Face ID del módulo original para calibrarse. Módulo de cámara trasera: stock genuino limitado — confirmar disponibilidad antes de cotizar." } },
