...
const CATALOG = [
  {
    ...
    products: [
      ...
      { supplier: "mobilesentrix", id: "12-battery-ms", category: "Battery", name: { en: "Battery", es: "Batería" }, gradeKey: "genuine-oem-apple", inStock: false, price: 46.98, colors: [], img: "images/battery-genuine-placeholder.jpg", note: { en: MS_NOTE_EN, es: MS_NOTE_ES } },
  ...
  },
  {
    ...
    products: [
      ...
      { supplier: "injured-gadgets", id: "15-earspeaker", category: "Speaker", name: { en: "Ear speaker", es: "Auricular" }, gradeKey: "genuine", inStock: true, price: 12.24, colors: [], img: "images/15pm-earspeaker.jpg", note: { en: "Proximity sensor flex sold separately, $11.32.", es: "El flex del sensor de proximidad se vende por separado, $11.32." } },
  ...
  },
  {
    ...
    products: [
      { supplier: "injured-gadgets", id: "16-housing", category: "Back housing", name: { en: "Back glass w/ small parts", es: "Tapa trasera de vidrio con piezas pequeñas" }, gradeKey: "genuine-oem-pull", inStock: true, price: 135.00, colors: ["Black Titanium", "White Titanium"], img: "images/16pm-housing.jpg", note: { en: "", es: "" } },
      { supplier: "injured-gadgets", id: "16-frontcam", category: "Camera", name: { en: "Front camera module", es: "Módulo de cámara frontal" }, gradeKey: "genuine", inStock: true, price: 127.26, colors: [], img: "images/16pm-frontcam.jpg", note: { en: "Requires Face ID transfer from the original module to calibrate. Rear camera module: limited genuine stock — confirm availability before quoting.", es: "Requiere transferir el Face ID del módulo original para calibrarse. Módulo de cámara trasera: stock genuino limitado — confirmar disponibilidad antes de cotizar." } },
      { supplier: "injured-gadgets", id: "16-loudspeaker", category: "Speaker", name: { en: "Loud speaker", es: "Altavoz" }, gradeKey: "genuine", inStock: true, price: 13.53, colors: [], img: "images/16pm-loudspeaker.jpg", note: { en: "", es: "" } },
      { supplier: "injured-gadgets", id: "16-earspeaker", category: "Speaker", name: { en: "Ear speaker w/ WiFi flex", es: "Auricular con flex WiFi" }, gradeKey: "genuine", inStock: false, price: 11.53, colors: [], img: "images/16pm-earspeaker.jpg", note: { en: "", es: "" } },
      ...
      { supplier: "mobilesentrix", id: "16-battery-ms", category: "Battery", name: { en: "Battery", es: "Batería" }, gradeKey: "genuine-oem-apple", inStock: false, price: 64.31, colors: [], img: "images/battery-genuine-placeholder.jpg", note: { en: MS_NOTE_EN, es: MS_NOTE_ES } },
      { supplier: "mobilesentrix", id: "16-frontcam-ms", category: "Camera", name: { en: "Front camera module", es: "Módulo de cámara frontal" }, gradeKey: "genuine-oem-apple", inStock: false, price: 173.22, colors: [], img: "images/16pm-frontcam.jpg", note: { en: MS_NOTE_EN, es: MS_NOTE_ES } },
  ...
  },
  {
    ...
    products: [
      ...
      { supplier: "mobilesentrix", id: "17-frontcam-ms", category: "Camera", name: { en: "Front camera module", es: "Módulo de cámara frontal" }, gradeKey: "genuine-oem-apple", inStock: false, price: 173.22, colors: [], img: "images/17pm-frontcam.jpg", note: { en: MS_NOTE_EN, es: MS_NOTE_ES } },
      ...
      { supplier: "mobilesentrix", id: "17-loudspeaker-ms", category: "Speaker", name: { en: "Loud speaker", es: "Altavoz" }, gradeKey: "genuine-oem-apple", inStock: true, price: 147.06, colors: [], img: "images/17pm-loudspeaker.jpg", note: { en: MS_NOTE_EN, es: MS_NOTE_ES } },
