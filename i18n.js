...
const UI_STRINGS = {
  en: {
    ...
    piroboCheckboxLabel: "Add \"chuzo max\" surcharge (extra 2.5% on cost, shipping, and handling)",
    piroboWarning: "Use only in case of client disrespect",
    piroboBreakdownTemplate: "\"Chuzo max\" adds 2.5% to the product cost, 2.5% to US shipping, and 2.5% to Colombia shipping (mathematically the same as 2.5% on their total), then a further 2.5% for \"handling\" on top of that already-inflated subtotal — about {pct}% extra on the suggested price overall.",
    free: "free",
  ...
  es: {
    ...
    piroboCheckboxLabel: "Agregar cargo \"chuzo max\" (2.5% extra en costo, envíos y manejo)",
    piroboWarning: "Usar solo en caso de falta de respeto del cliente",
    piroboBreakdownTemplate: "El cargo \"chuzo max\" suma 2.5% al costo del producto, 2.5% al envío a EE. UU. y 2.5% al envío a Colombia (matemáticamente lo mismo que sumar 2.5% a su total), y luego otro 2.5% de \"manejo\" sobre ese subtotal ya inflado — en total, aproximadamente un {pct}% adicional sobre el precio sugerido.",
    free: "gratis",
